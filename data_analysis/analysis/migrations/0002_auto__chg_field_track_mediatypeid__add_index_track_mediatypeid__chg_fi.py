...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Track.mediatypeid'
        db.alter_column(u'Track', u'MediaTypeId', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['analysis.Mediatype'], db_column=u'MediaTypeId'))
        # Adding index on 'Track', fields ['mediatypeid']
        db.create_index(u'Track', [u'MediaTypeId'])


        # Changing field 'Track.albumid'
        db.alter_column(u'Track', u'AlbumId', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['analysis.Album'], null=True, db_column=u'AlbumId'))
        # Adding index on 'Track', fields ['albumid']
        db.create_index(u'Track', [u'AlbumId'])


        # Changing field 'Invoiceline.trackid'
        db.alter_column(u'InvoiceLine', u'TrackId', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['analysis.Track'], db_column=u'TrackId'))
        # Adding index on 'Invoiceline', fields ['trackid']
        db.create_index(u'InvoiceLine', [u'TrackId'])


    def backwards(self, orm):
        # Removing index on 'Invoiceline', fields ['trackid']
        db.delete_index(u'InvoiceLine', [u'TrackId'])

        # Removing index on 'Track', fields ['albumid']
        db.delete_index(u'Track', [u'AlbumId'])

        # Removing index on 'Track', fields ['mediatypeid']
        db.delete_index(u'Track', [u'MediaTypeId'])


        # Changing field 'Track.mediatypeid'
        db.alter_column(u'Track', u'MediaTypeId', self.gf('django.db.models.fields.IntegerField')(db_column=u'MediaTypeId'))

        # Changing field 'Track.albumid'
        db.alter_column(u'Track', u'AlbumId', self.gf('django.db.models.fields.IntegerField')(null=True, db_column=u'AlbumId'))

        # Changing field 'Invoiceline.trackid'
        db.alter_column(u'InvoiceLine', u'TrackId', self.gf('django.db.models.fields.IntegerField')(db_column=u'TrackId'))
